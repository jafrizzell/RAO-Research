...
plt.title('Surge RAO')
plt.text(mean(x_axis), (mean(orig_x)+mean(pred_x))/2, str(x_err_rpd)+'\n'+str(x_err_raw))
plt.grid()
# plt.ylim([-0.5, 1.5])
...
plt.title('Sway RAO')
plt.text(mean(x_axis), (mean(orig_y)+mean(pred_y))/2, str(y_err_rpd)+'\n'+str(y_err_raw))
plt.grid()
# plt.ylim([-0.5, 1.5])
...
plt.title('Heave RAO')
plt.text(mean(x_axis), (mean(orig_z)+mean(pred_z))/2, str(z_err_rpd)+'\n'+str(z_err_raw))
plt.grid()
# plt.ylim([-0.5, 1.5])
...
plt.title('Roll RAO')
plt.text(mean(x_axis), (mean(orig_rx)+mean(pred_rx))/2, str(rx_err_rpd)+'\n'+str(rx_err_raw))
# plt.ylim([-0.5, 1.5])
...
plt.title('Pitch RAO')
plt.text(mean(x_axis), (mean(orig_ry)+mean(pred_ry))/2, str(ry_err_rpd)+'\n'+str(ry_err_raw))
# plt.ylim([-0.5, 50])
plt.grid()
plt.xlabel('Wave Frequency (rad/s)')
...
plt.title('Yaw RAO')
plt.text(mean(x_axis), (mean(orig_rz)+mean(pred_rz))/2, str(rz_err_rpd)+'\n'+str(rz_err_raw))
# plt.ylim([-0.5, 1.5])
plt.grid()
plt.xlabel('Wave Frequency (rad/s)')
